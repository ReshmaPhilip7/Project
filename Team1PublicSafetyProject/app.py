...
# Load models
aqi_model = path.join(app.root_path, "models", "rf_model.pkl")
with open(aqi_model, "rb") as f:
    aqi_model = pickle.load(f)

health_model = path.join(app.root_path, "models", "dt_cls_model.pkl")
with open(health_model, "rb") as f:
    health_model = pickle.load(f)

water_model = path.join(app.root_path, "models", "rf_model_water.pkl")
